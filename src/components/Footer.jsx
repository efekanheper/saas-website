...
const Footer = () => {
  return (
    <footer className="mt-20 text-neutral-400">
      <div className="max-w-7xl mx-auto px-4 border-t border-indigo-800">
        ...
        <div
          className="my-12 border-t border-neutral-800 pt-8
                    text-center text-sm text-neutral-50"
        >
          <div className="flex justify-between">
            <div className="text-xs">
              <div className="flex space-x-6">
                {FOOTER_CONTENT.socialLinks.map((social, idx) => (
                  <a
                    key={idx}
                    href={social.url}
