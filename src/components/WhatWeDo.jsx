  ...
  return (
    <section>
      <div className="max-w-7xl mx-auto px-4 mt-20">
        <div className="text-center mb-12 border-t border-indigo-800">
          <h2
            className="text-3xl lg:text-5xl mt-20 tracking-tighter
                bg-gradient-to-t from-indigo-50 via-indigo-300 to-indigo-600
                bg-clip-text text-transparent"
          >
            {WHAT_WE_DO.sectionTitle}
          </h2>
          <p className="mt-4">{WHAT_WE_DO.sectionDescription}</p>
        </div>
        <motion.div
        ...
        >
          {WHAT_WE_DO.features.map((feature) => (
            <motion.div
              key={feature.id}
